...
/*   Updated: 2025/06/05 16:16:44 by mtbanban         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

export const newPseudo = () => `
<div id="newPseudo" class="fixed w-full h-full hidden inset-0 flex flex-col gap-4 justify-center items-center bg-black/80 z-20">
                  <input 
                    type="text"
