export const tournamentPage8 = () => `
    <div class="h-full w-full overflow-y-auto ">
        <div id="tournamentList" class="flex flex-row items-center justify-center h-full w-full">
            ...
            <div id="player3" class="flex flex-col items-center justify-center h-full w-full gap-4">
            ...
            <div id="player4" class="flex flex-col items-center justify-center h-full w-full gap-8">
                <img src="/img/barTournament.png" alt="tournament" class="w-[30%] h-[30%] rounded-full object-cover mt-4"/>
                <img src="/img/barTournament.png" alt="tournament" class="w-[30%] h-[30%] rounded-full object-cover mt-8"/>
            </div>
            <div id="finalll" class="flex flex-col items-center justify-center h-full w-full">
                <div id="final" class="flex flex-col items-center justify-center h-full w-[40%] gap-20">
                    <p class="flex flex-col mt-4">Player1</p>
                    <p class="flex flex-col mt-10">Player2</p>
                </div>
            </div>
            <div id="player4" class="flex flex-col items-center justify-center h-full w-full">
                <img src="/img/barTournament.png" alt="tournament" class="w-[30%] h-[40%] rounded-full object-cover"/>
            </div>
            <div id="finalll" class="flex flex-col items-center justify-center h-full w-full">
