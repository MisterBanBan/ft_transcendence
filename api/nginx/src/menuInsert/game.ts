...
/*   Updated: 2025/07/25 16:45:54 by mtbanban         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
<div id="game" class="flex responsive-form-login flex-col items-center  justify-center">
  ...
  <div id="game-options" class="flex flex-col items-center justify-center mt-4 responsive-game-gap relative w-[40%] ">
    <div id="Offline" class="menu-option  text-white responsive-text font-omori cursor-pointer">Offline</div>
    ...
    <div id="Tournament" class="menu-option  text-white responsive-text font-omori cursor-pointer">Tournament</div>
