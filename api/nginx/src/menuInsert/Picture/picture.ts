    ...
    <div class="w-full h-full flex flex-col relative">
        <div class="w-full h-[46%] flex items-center justify-center relative">
            <button
                type="button"
                id="picture-profile"
                class="w-[65%] h-[68%] mt-4 mr-4 bg-[url(${fullAvatarPath})] bg-[length:100%_100%] bg-no-repeat bg-center z-20 pointer-events-auto flex items-center justify-center rounded-full hover:scale-105 transition-transform duration-200 cursor-pointer"
